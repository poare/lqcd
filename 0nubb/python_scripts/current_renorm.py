...
for q_idx, q in enumerate(q_list):
    ...
    GammaVslash, GammaAslash = np.zeros(GV_boot.shape[1:]), np.zeros(GA_boot.shape[1:])
    ...
    ZA[q_idx] = 12 * Zq[q_idx] * square(q_lat) * np.einsum('zaiaj,jk,ki->z', GammaAslash, gamma5, qlat_slash)
