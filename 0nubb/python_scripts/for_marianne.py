...
################################################################################
# LSQFIT. 
# We're fitting a number of different renormalization coefficients: 
# Zq, ZV, ZA, F11, F22, F33, F44, F55, F23, F32, F45, F54 (12 = n_vars)
# For each renormalization coefficient Z, it has an ensemble index and a bootstrap index. 
# We get the mean and covariance over different bootstraps, then use this to 
# fit the data over different ensembles (which act like the time index in an effective mass fit). 
################################################################################
