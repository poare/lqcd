...
for q_idx, q in enumerate(q_list):
    ...
    for mu in range(4):
        ...
        GammaV[mu], GammaA[mu] = amputate_threepoint(props_q_inv, props_q_inv, GV_boot[mu]), amputate_threepoint(props_q_inv, props_q_inv, GA_boot[mu])
...
################################## SAVE DATA ##################################
out_file = '/Users/theoares/Dropbox (MIT)/research/0nubb/analysis_output/currents' + str(job_num) + '/Z_momfrac.h5'
