...
smeared=/data/d10b/ensembles/isoClover/cl3_32_48_b6p1_m0p2450_smeared
writeto=/data/d10b/ensembles/isoClover/cl3_32_48_b6p1_m0p2450_smeared_gf

export OMP_NUM_THREADS=64

for ((traj=1500; traj<=9900; traj++)); do
