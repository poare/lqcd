"""
Uses output data from precious spectral function simulation to generate a new spectral 
function to simulate and saves it to an hdf5 file.
...
def main():
    ...
    print('Using input from: ' + input_name)

    new_w, new_ng = read_eig_cut(input_name)
